...
| # | Phase | Status | File |
|---|-------|--------|------|
| —  | Audio narration via AshStorage (ADR-0001) | Phase 1 shipped; Phase 2 (recorder JS + upload) next | [active/2026-04-24-audio-narration.md](active/2026-04-24-audio-narration.md) |
